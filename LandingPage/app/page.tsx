...
export default function FreshCartPage() {
    ...
    <div className="min-h-screen bg-[#f8faf8] text-[#191c1e] flex flex-col relative selection:bg-[#c9ebd1] selection:text-[#09733e]">
      ...
      <header className="relative z-20 w-full px-6 sm:px-10 lg:px-16 py-6 max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-6 md:gap-8">
          ...
          >
            {/* Organic Cart Icon */}
            <div className="w-8 h-8 rounded-lg bg-[#e5f5e8] flex items-center justify-center text-[#09733e] group-hover:scale-105 transition-transform duration-200 shadow-2xs border border-[#c4e4ca]">
              <svg 
                viewBox="0 0 24 24" 
        ...
        {/* Center: Nav links (Single Page / Coming Soon) */}
        <nav className="hidden lg:flex items-center gap-10">
          <span 
            id="nav-home-link"
            className="text-sm font-bold text-[#09733e] relative py-1 cursor-default"
          >
            Home
          ...
          <button 
            type="button"
            id="nav-features-btn"
            onClick={() => showToast("🌱 Smart harvest tracking & instant cold-chain delivery launching in Phase 1.")}
            className="text-sm font-semibold text-slate-600 hover:text-[#09733e] transition-colors cursor-pointer"
          >
            Features
          </button>
          <button 
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            onClick={() => setIsWaitlistOpen(true)}
            className="hidden sm:inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-[#09733e] hover:bg-[#075c31] active:scale-[0.98] text-white font-medium text-sm transition-all duration-200 shadow-md shadow-[#09733e]/15 cursor-pointer"
          >
          ...
          >
            <div className="flex flex-col gap-4">
              <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider">
                FreshCart: The Smarter Way to Shop
              </div>
              <span className="text-base font-semibold text-[#09733e]">
                Home
              </span>
              <button 
                type="button"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center w-full">
          ...
          >
            ...
            >
              ...
              <span className="relative inline-block text-[#09733e]">
                future
                <svg
                  className="absolute -bottom-2.5 left-0 w-full h-3 text-[#09733e]/50 overflow-visible"
                  viewBox="0 0 100 20"
                  preserveAspectRatio="none"
                  aria-hidden="true"
                >
                  <path
                    d="M0,14 Q50,4 100,14"
                    fill="none"
                    stroke="#a3cca8"
                    strokeWidth="3.5"
                    strokeLinecap="round"
              ...
              <span className="text-[#191c1e]"> of grocery</span> <br />
              <span>shopping.</span>
            </h1>
            ...
            {/* Subtle Divider */}
            <div className="w-48 h-px bg-slate-200/80 mt-8 mb-6" />

            {/* Early Access Avatars & Social Proof */}
            <div 
              id="early-access-row"
              onClick={() => setIsWaitlistOpen(true)}
              className="flex items-center gap-3.5 cursor-pointer group p-1 -ml-1 rounded-xl hover:bg-slate-100/60 transition-colors"
            >
              {/* Stacked 3 Avatars */}
              ...
              >
                ...
                <div className="relative z-10 text-center flex flex-col items-center justify-center my-auto">
                  <h2 
                    ...
                    className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#0e7a3e] tracking-tight leading-tight"
                  >
                    Coming Soon
                  </h2>
                  <p 
                    id="card-preorder-subtext"
                    className="text-xs sm:text-sm md:text-base font-medium text-[#2c7849] mt-1.5 sm:mt-2"
                  >
              ...
              {isSubmitted ? (
                <div className="text-center py-6">
                  ...
                  <p className="text-sm text-slate-600 mt-2">
                    We&apos;ll notify you the moment FreshCart is ready for download in your area.
                  </p>
                </div>
              ) : (
                <div>
